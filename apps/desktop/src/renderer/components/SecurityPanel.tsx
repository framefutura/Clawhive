...
import type { SecurityLevel, PermissionMatrix } from '../../main/security-manager'
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {Object.entries(permissions.tools).map(([tool, permission]) => (
                  <div
                    key={tool}
              ...
              <div className="space-y-2 text-sm">
                {permissions.files.read.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {permissions.files.read.map((path) => (
                ...
                {permissions.files.write.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {permissions.files.write.map((path) => (
                ...
                {permissions.files.deny.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {permissions.files.deny.map((path) => (
              ...
              <div className="space-y-2 text-sm">
                {permissions.network.allowHosts.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {permissions.network.allowHosts.map((host) => (
                ...
                {permissions.network.denyHosts.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {permissions.network.denyHosts.map((host) => (
